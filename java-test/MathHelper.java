...
public class MathHelper
{
     ...
     */
    public static final int[] MULTIPLY_DE_BRUIJN_BIT_POSITION;
    public static final double FRAC_BIAS;
    public static final double[] ASINE_TAB;
    public static final double[] COS_TAB;
